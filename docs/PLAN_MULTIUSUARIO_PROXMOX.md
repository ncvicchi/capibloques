...
Estado: **fases 0 a 5 implementadas y verificadas en DEV; fase 5 lista para validación del propietario** (7 de septiembre de 2026). La fase 4 incluye autoguardado, recuperación local, salida compartida, continuidad durante cortes, borradores de escena, historial restaurable y purga individual confirmada. Alcance y pruebas en [fase 4 completa](FASE_4_RECUPERACION_E_HISTORIAL.md). La [fase 5 completa](FASE_5_SUPERVISION_DOCENTE.md) incorpora revisión de sólo lectura, simulación, copias y devoluciones sobre versiones protegidas. El propietario pidió avanzar por fases completas, no por subfases. La autorización de supervisión no incluye las fases pendientes 6–11.
...
Numeración vigente: fases consecutivas 0–11, sin letras. Las fases 0–5 están implementadas en DEV; quedan las fases 6–11. Esta corrección de numeración no cambia alcance, estado ni autorizaciones. Los nombres de las guías históricas se conservan para mantener sus enlaces; no son fases independientes del plan actual.
...
| 6. Experiencia y programación | Avatares, favoritos, inicio único, «al mismo tiempo» y ejecución visible | Las preferencias persisten por usuario; sólo hay un inicio en todas las rutas de edición/importación; la migración conserva concurrencia; cada paso guiado es legible y coincide con la traza lógica normal; pasa simulación/compilación Wemos. |
