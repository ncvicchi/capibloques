...
Estado: **fases 0 a 5 implementadas y verificadas en DEV; fase 6 autorizada y en implementación** (7 de septiembre de 2026). La fase 4 incluye autoguardado, recuperación local, salida compartida, continuidad durante cortes, borradores de escena, historial restaurable y purga individual confirmada. Alcance y pruebas en [fase 4 completa](FASE_4_RECUPERACION_E_HISTORIAL.md). La [fase 5 completa](FASE_5_SUPERVISION_DOCENTE.md) incorpora revisión de sólo lectura, simulación, copias y devoluciones sobre versiones protegidas. El propietario pidió avanzar por fases completas, no por subfases. El propietario autorizó la fase 6 completa; las fases 7–11 siguen pendientes de autorización.
...
Numeración vigente: fases consecutivas 0–11, sin letras. Las fases 0–5 están implementadas en DEV; la fase 6 está en implementación y las fases 7–11 quedan pendientes. Esta corrección de numeración no cambia alcance, estado ni autorizaciones. Los nombres de las guías históricas se conservan para mantener sus enlaces; no son fases independientes del plan actual.
...
| 6. Experiencia y programación · en implementación | Avatares, favoritos, inicio único, «al mismo tiempo» y ejecución visible | Las preferencias persisten por usuario; sólo hay un inicio en todas las rutas de edición/importación; la migración conserva concurrencia; cada paso guiado es legible y coincide con la traza lógica normal; pasa simulación/compilación Wemos. |
| 7. Mensajes y pantalla | Destinos explícitos consola/Serial y pantalla | Se simula y genera el mismo texto, el perfil físico tiene conexiones validadas y compila; los mensajes o el display ausente no congelan la ejecución. |
