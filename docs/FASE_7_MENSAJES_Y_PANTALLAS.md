...
- Validar límites de texto, layout y conexiones, incluyendo bus I2C compartido y direcciones; fallos o ausencia de pantalla no pueden introducir esperas indefinidas.
...
Se consultó al propietario el modelo inicial. Propuesta pendiente de respuesta: LCD I2C 16×2/20×4 y OLED SSD1306 128×64. La estructura de mensajes y componentes no dependerá de esos modelos.
