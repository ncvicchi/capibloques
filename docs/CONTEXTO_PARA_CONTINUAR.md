...
- 27: **en curso**; el perfil genérico Otto básico ESP32 de cuatro servos ya tiene escena, calibración, movimientos cooperativos, simulación, JSON y ambos generadores. Falta aceptación física y los perfiles con buzzer, ultrasonido, matriz/expresiones, Ninja y Wheels. Ver [FASE_27_OTTO.md](FASE_27_OTTO.md).
