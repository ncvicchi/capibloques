...
- 20: **asistente base `9914ae8`; selección visual Wemos/DIYmall publicada en `1904e76`**. Muestra «Placa actual» con foto, previsualiza las conexiones que cambiarán y confirma antes de modificar escena/perfil. Waveshare alterna frente/dorso, pero está deshabilitada porque su intérprete de panel/touch aún no existe. Quedan historial global del cambio y aceptación física. Arduino/ESP-IDF, compilación específica y monitor Serial permanecen avanzados. DEV sigue en `8103b14`; ver [FASE_20_USO_GUIADO_PLACA.md](FASE_20_USO_GUIADO_PLACA.md).
...
- 34: pendiente; Pantalla central Wi‑Fi y servicios tipados. La Placa del proyecto es autoridad única, envía telemetría y sigue autónoma al desconectarse; la Waveshare refleja la escena y envía botones, mensajes, sensores virtuales o solicitudes publicadas, nunca GPIO/código arbitrario. Ver [FASE_34_PANTALLA_CENTRAL_WIFI.md](FASE_34_PANTALLA_CENTRAL_WIFI.md).
