...
- 36: **autorizada y en curso**. Primera entrega software: `CapiRules` v1/ABI 1 binario y acotado, `CapiLink`, selector Simulador/Placa, actualización Web Serial, commit A/B posterior a verificación, arranque autónomo, telemetría, runtime base Wemos/S3 y generación reproducible de artefactos fuera de Git. La negociación bloquea firmware viejo, placa/ABI incorrecta y capacidades ausentes. El runtime 1.0 ya declara núcleo, paralelo/fork-join, expresiones/variables, entradas analógicas/digitales, GPIO, LED, semáforo, motores/robot, servo, buzzers, matriz MAX7219 cooperativa, Mensajes con trama protegida, Otto genérico, LCD 16×2/20×4, SSD1306 e ILI9341/ILI9488, Wi‑Fi cliente con aprovisionamiento USB privado, contador y consola. RGB, compilación del runtime ampliado y aceptación física siguen pendientes. Plan/estado en [FASE_36_FIRMWARE_INTERPRETE.md](FASE_36_FIRMWARE_INTERPRETE.md).
