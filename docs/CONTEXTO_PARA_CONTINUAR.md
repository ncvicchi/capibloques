...
- 20: **asistente base `9914ae8`; selección visual Wemos/DIYmall publicada en `1904e76`; pareja Waveshare implementada en software el 25 de septiembre**. Presenta Placa del proyecto obligatoria + Pantalla central opcional, persiste identidad/SSID no secretos y configura automáticamente ambas con `WSMMMMMM`, contraseña local y rol por Web Serial/CapiLink 1.5.0; el alumno no elige Wi-Fi. Quedan escena/touch remotos, historial global del cambio, DEV y aceptación física. Arduino/ESP-IDF, compilación específica y monitor Serial permanecen avanzados; ver [FASE_20_USO_GUIADO_PLACA.md](FASE_20_USO_GUIADO_PLACA.md).
