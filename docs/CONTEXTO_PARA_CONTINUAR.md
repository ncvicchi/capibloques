...
- 20: **asistente base `9914ae8`; selección visual Wemos/DIYmall publicada en `1904e76`; pareja Waveshare implementada en software el 25 de septiembre**. Distingue Waveshare principal como simulación virtual sin GPIO y, para proyectos físicos, Placa del proyecto obligatoria + Pantalla central opcional. La pareja persiste identidad/SSID no secretos y configura automáticamente ambas con `WSMMMMMM`, contraseña local y rol por Web Serial/CapiLink 1.5.0; el alumno no elige Wi-Fi. Quedan renderer LCD, escena/touch remotos, historial global del cambio, DEV y aceptación física. Arduino/ESP-IDF, compilación específica y monitor Serial permanecen avanzados; ver [FASE_20_USO_GUIADO_PLACA.md](FASE_20_USO_GUIADO_PLACA.md).
...
- 34: **base de pareja implementada en software**; selección dual, `WSMMMMMM`, contraseña/clave generadas localmente, NVS y provisión de AP/cliente están entregados en CapiLink 1.5.0. Faltan canal autenticado, descriptor/telemetría, escena RGB, touch, entradas/servicios, DEV y aceptación física. La placa ejecutora seguirá siendo autoridad única. Ver [FASE_34_PANTALLA_CENTRAL_WIFI.md](FASE_34_PANTALLA_CENTRAL_WIFI.md).
...
- 36: **base desplegada en DEV el 24 de septiembre; extensión 1.5.0 pendiente de DEV**. `CapiRules` v1/ABI 1 binario y acotado, `CapiLink`, actualización Web Serial, commit A/B, arranque autónomo, telemetría y artefactos fuera de Git. Los intérpretes 1.4.0 de Wemos/DIYmall están publicados; 1.5.0 agrega identidad/provisión de pareja y un tercer artefacto Waveshare que debe construirse en la próxima actualización. Falta aceptación física. Plan/estado en [FASE_36_FIRMWARE_INTERPRETE.md](FASE_36_FIRMWARE_INTERPRETE.md).
