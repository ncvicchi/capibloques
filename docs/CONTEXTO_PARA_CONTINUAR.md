...
- 20: **asistente base, selección y pareja Waveshare implementados en software**. Distingue Waveshare principal virtual y Pantalla central opcional. Con 1.5.4, `RUN` inicia también el espejo web a 1×, minimiza el asistente sin cerrar Web Serial y deja controles flotantes sincronizados; el registro usa nombres de escena y resultados concretos, no IDs internos. Quedan escena/touch remotos, historial global del cambio, DEV y aceptación física. Ver [FASE_20_USO_GUIADO_PLACA.md](FASE_20_USO_GUIADO_PLACA.md).
