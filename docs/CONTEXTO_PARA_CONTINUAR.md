...
- 20: **terminada en software**; el recorrido infantil es Usar en placa → Conectar → Preparar firmware CapiBloques cuando haga falta → Enviar reglas y ejecutar. Arduino/ESP-IDF, compilación específica y monitor Serial se conservan bajo Herramientas avanzadas para adultos. Falta aceptación física; ver [FASE_20_USO_GUIADO_PLACA.md](FASE_20_USO_GUIADO_PLACA.md).
