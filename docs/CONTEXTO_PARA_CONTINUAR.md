...
- 18: **reabierta/en curso**; el tablero lógico entregado es una base. El objetivo aclarado es dibujar la misma escena y combinar componentes reales —sólo mediante interfaces/controladores compatibles— con otros simulados en la pantalla, bajo un único programa. Falta implementar ese modo híbrido, DEV y aceptación táctil/física; ver [FASE_18_CONTROLES_LOCALES.md](FASE_18_CONTROLES_LOCALES.md).
