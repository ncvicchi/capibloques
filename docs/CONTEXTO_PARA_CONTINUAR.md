...
- 35: software terminado; luces RGB direccionables, con aceptación física pendiente. Fases 38–41 siguen pendientes en [COMPONENTES_A_IMPLEMENTAR.md](COMPONENTES_A_IMPLEMENTAR.md).
