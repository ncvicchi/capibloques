...
- 36: **base desplegada en DEV el 24 de septiembre; extensión 1.5.3 pendiente de DEV**. `CapiRules` v1/ABI 1 binario y acotado, `CapiLink`, actualización Web Serial, commit A/B, arranque autónomo, telemetría y artefactos fuera de Git. Los intérpretes 1.4.0 de Wemos/DIYmall están publicados; 1.5.0 agregó identidad/provisión de pareja y un tercer artefacto Waveshare. La primera prueba física reveló un watchdog, corregido en 1.5.1; 1.5.2 agregó el transporte dual USB Serial/JTAG/UART y 1.5.3 acepta el driver USB ya instalado por ESP-IDF. Debe reconstruirse, grabarse y confirmarse físicamente. Plan/estado en [FASE_36_FIRMWARE_INTERPRETE.md](FASE_36_FIRMWARE_INTERPRETE.md).
