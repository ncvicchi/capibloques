...
const displayNotes: Record<DisplayProfile, Pick<HelpSeed, 'technicalName' | 'summary' | 'needs' | 'limits'>> = {
  ...
  waveshare5: { technicalName: 'Waveshare ESP32-S3 Touch LCD 5 SKU 28117', summary: 'Es la pantalla táctil integrada de 800 × 480 píxeles de esta placa.', needs: ['Waveshare SKU 28117'], limits: 'Perfil exclusivo de esa placa. El touch informa coordenadas y la fase de controles agrega su uso visual; los conectores externos no se presentan como GPIO genéricos.' },
};
