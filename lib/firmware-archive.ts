...
`,
  ...
  PRIV_REQUIRES esp_driver_gpio esp_driver_ledc esp_driver_i2c esp_driver_spi esp_driver_uart esp_driver_rmt
  esp_adc esp_timer esp_wifi esp_event esp_netif nvs_flash freertos esp_lcd${s3 ? ' esp_psram' : ''})
