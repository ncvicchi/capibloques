...
for profile in ('main', 'auxiliary', 'matrix', 'smart-lights', 'lcd1602keypad', 'lcd1602', 'lcd2004', 'ssd1306', 'ili9341', 'ili9488', 'waveshare5', 's3'):
    with zipfile.ZipFile(root / f'{profile}.zip') as archive:
        ...
        assert manifest['chip'] == ('esp32s3' if profile in ('s3', 'waveshare5') else 'esp32')
