...
urlpatterns = [
    ...
    path("api/projects/<uuid:project_id>/history/", projects.history_list),
    path("api/projects/<uuid:project_id>/history/<int:revision>/", projects.history_detail),
    path("api/projects/<uuid:project_id>/history/<int:revision>/restore/", projects.history_restore),
    path("api/projects/<uuid:project_id>/purge/", projects.purge),
