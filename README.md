...
El editor exige ingreso con alias y contraseña. En la VM de desarrollo corren Django + PostgreSQL, cuentas, cursos y proyectos personales. GitHub Pages ya no se utiliza. Las fases 0–9 están entregadas, la fase 10 conserva su aceptación física pendiente y las fases 11–13 están entregadas. La [fase 12](docs/FASE_12_MESA_DE_TRABAJO.md) reorganiza la mesa de trabajo y la [fase 13](docs/FASE_13_ACCESO_EXTERNO_DEV.md) publica DEV de forma persistente en [capibloques.dev.nvicchi.com](https://capibloques.dev.nvicchi.com/). Las [fases 14–18](docs/PLAN_FASES_BACKLOG.md) requieren autorización propia. Producción es la **Fase final, postergada**.
