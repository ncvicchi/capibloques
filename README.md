...
El [backlog](docs/BACKLOG.md) distingue lo implementado y las correcciones posteriores de lo pendiente. [Mensajes](docs/FASE_15_MENSAJES.md) ya ofrece envío/recepción protegido y simulado; la [Matriz LED](docs/FASE_23_MATRIZ_LED.md) ya tiene editor 32 × 8, simulación y firmware Arduino/ESP-IDF, aunque su aceptación física y la de los demás displays continúan pendientes. La [fase 20](docs/FASE_20_USO_GUIADO_PLACA.md) convierte el firmware intérprete y las reglas en el recorrido normal de placa, dejando compilación nativa y monitor Serial como herramientas avanzadas. También quedan desafíos, UX, avatar, panel móvil, compartir por enlace/QR y acceso de aula.
