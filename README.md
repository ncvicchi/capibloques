...
**Mis proyectos** permite abrir, buscar, renombrar, duplicar, exportar y enviar a una papelera recuperable. Se comprueba la revisión para no pisar cambios de otra pestaña. Importar y cargar un ejemplo crean trabajos independientes; antes de reemplazar cambios locales se ofrece Guardar/Descartar/Cancelar. Además se conserva el borrador **local** por UUID de cuenta. Los reintentos automáticos de 4A conservan su operación sólo mientras sigue abierto el editor: no son una cola durable ni un modo offline. Antes de salir con envíos sin confirmar, reintentar o exportar JSON. Si no puede verificarse la sesión, el editor se bloquea hasta revalidarla.
